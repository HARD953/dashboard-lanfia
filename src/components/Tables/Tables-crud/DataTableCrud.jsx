           ...
           <Toast ref={toast} />
            ...
            <div className="data-table-container">
                ...
                <DataTable ref={dt} value={products} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                    ...
                    <Column field="code" header="Code"  style={{ minWidth: '5rem' }}></Column>
                    <Column field="name" header="Nom"  style={{ minWidth: '16rem' }}></Column>
                    <Column field="image" header="Commune" body={imageBodyTemplate}  style={{ minWidth: '16rem' }}></Column>
                    <Column field="price" header="Fonction" body={priceBodyTemplate}  style={{ minWidth: '15rem' }}></Column>
                    <Column field="rating" header="Etat" body={ratingBodyTemplate}  style={{ minWidth: '10rem' }}></Column>
